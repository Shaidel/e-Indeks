    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentLecturers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendantLimit = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentLecturers_DepartmentId",
                table: "DepartmentLecturers",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentLecturers_LecturerId",
                table: "DepartmentLecturers",
                column: "LecturerId");
