...
namespace AndrewApp.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var mainContext = _context.Projects.Include(p => p.Class);
        ...
        public async Task<IActionResult> Create([Bind("Id,ClassId,Subject,AttendantLimit")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClassId,Subject,AttendantLimit")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
